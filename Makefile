...
render/monochord_lasercut_thin.svg: monochord_lasercut.scad lasercut/lasercut.scad lasercut/convert-2d.py lasercut/pack_svg.py
	./lasercut/convert-2d.py --pack -k -D inner_length=$(inner_length) -D wall_th=$(wall_th) -D thick_th=$(thick_th) -D generate_only=$(wall_th) monochord_lasercut.scad render/monochord_lasercut_thin.svg
...
render/monochord_lasercut_thick.svg: monochord_lasercut.scad lasercut/lasercut.scad lasercut/convert-2d.py lasercut/pack_svg.py
	./lasercut/convert-2d.py --pack -k -D inner_length=$(inner_length) -D wall_th=$(wall_th) -D thick_th=$(thick_th) -D generate_only=$(thick_th) monochord_lasercut.scad render/monochord_lasercut_thick.svg
